  ...
  <nav class:scrolled={scrollY > 50}>
    <div class="nav-content">
      ...
      <div class="nav-links">
        ...
        <a href="#voice">语音识别</a>
        <a href="/coolwulfIMEv0.77.1420.apk" class="btn-nav" download>立即下载</a>
      </div>
    </div>
  </nav>
  ...
  <section class="hero" class:visible={visible.hero}>
    ...
    <div class="hero-content">
      ...
      <div class="hero-buttons">
        <a href="/coolwulfIMEv0.77.1420.apk" class="btn btn-primary" download>
          <span>立即下载</span>
    ...
    <div class="container">
      <div class="cta-content">
        ...
        <div class="cta-buttons">
          <a href="/coolwulfIMEv0.77.1420.apk" class="btn btn-primary btn-large" download>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="24" height="24">
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>
            </svg>
            <span>下载 APK (v0.77)</span>
          </a>
